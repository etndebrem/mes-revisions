...
(function () {
  ...
  var FICHE_PARTS = window.FICHE_PARTS || ["Sources of law", "The courts", "People in courts"];
  ...
  function renderFiches() {
    ...
    c.innerHTML =
      '<div class="row"><input type="search" id="fiche-search" placeholder="🔎 Rechercher (thème, arrêt, mot-clé…)" value="' + esc(fstate.search) + '"></div>' +
