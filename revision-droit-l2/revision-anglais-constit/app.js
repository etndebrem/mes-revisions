/* ===== Révisions UK Constitutional Law (P. Ducoulombier) — logique ===== */
(function () {
  "use strict";

  var DATA = (window.REPERTOIRE || []).slice();
  var STORE_KEY = "ukconst_leitner_v1";
  ...
  function renderControls() {
    ...
    c.innerHTML =
      '<div class="row"><input type="search" id="rep-search" placeholder="🔎 Search (case, statute, concept, keyword…)" value="' + esc(state.search) + '"></div>' +
      '<div class="row"><span class="filterlabel">Type</span><div class="chipset">' + typeChips + '</div></div>' +
      '<div class="row"><span class="filterlabel">Theme</span><div class="chipset">' + themeChips +
      '<button class="fchip" id="rep-reset" title="Tout réafficher">✕ reset</button></div></div>';
  ...
  function setTab(tab) {
    ...
    var qcmView = $("#view-qcm");
    if (qcmView) qcmView.style.display = tab === "qcm" ? "block" : "none";
