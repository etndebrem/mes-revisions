/* ===== Révisions Histoire du droit des obligations — logique ===== */
(function () {
  "use strict";

  var DATA = (window.REPERTOIRE || []).slice();
  var STORE_KEY = "histdroit_leitner_v1";
  var TYPE_LABEL = { auteur: "Auteur / juriste", notion: "Notion / mécanisme", texte: "Texte / source / article", adage: "Adage / maxime" };
  var TYPE_SHORT = { auteur: "Auteur", notion: "Notion", texte: "Texte", adage: "Adage" };
  ...
  var TYPES = ["auteur", "notion", "texte", "adage"];
